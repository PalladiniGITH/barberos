...
const sidebarItems: SidebarItem[] = [
  ...
  },
  {
    ...
    icon: CalendarClock,
    label: 'Agenda',
    description: 'Horarios do dia e da semana.',
    section: 'essencial',
  },
  {
    href: '/clientes',
    icon: UserRound,
    label: 'Clientes',
    description: 'Base, historico e leitura por cliente.',
    section: 'essencial',
  },
  {
    href: '/inteligencia',
    icon: BrainCircuit,
    label: 'Inteligencia',
    description: 'Analise automatica do negocio.',
    section: 'essencial',
  },
  {
    href: '/indicadores',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description: 'Leitura de tendencia.',
        section: 'modulos',
      },
    ],
  },
  {
    ...
    icon: Users,
    label: 'Equipe',
    description: 'Metas e desempenho do time.',
    section: 'modulos',
    children: [
      {
        href: '/equipe',
        icon: Users,
        label: 'Visao geral',
        description: 'Resumo comercial da equipe.',
        section: 'modulos',
        exact: true,
      },
      {
    ...
    children: [
      {
        ...
        icon: Wallet,
        label: 'Visao geral',
        description: 'Resumo de rentabilidade.',
        section: 'modulos',
        exact: true,
      },
      {
        ...
        icon: BarChart3,
        label: 'Resultado',
        description: 'Leitura consolidada da margem.',
        section: 'modulos',
      },
      {
        ...
        icon: Scissors,
        label: 'Servicos',
        description: 'Preco e margem por servico.',
        section: 'modulos',
      },
      {
        ...
        icon: Zap,
        label: 'Insumos',
        description: 'Base de custos e reposicao.',
        section: 'modulos',
      },
    ],
  },
...
function SidebarLink({
  ...
  const iconSizeClass = compact ? 'h-10 w-10 rounded-[0.95rem]' : level === 0 ? 'h-10 w-10 rounded-[1rem]' : 'h-[2.3rem] w-[2.3rem] rounded-[0.9rem]'

  return (
    <div
      className={cn(
        'min-w-0',
        isTopLevel ? 'space-y-1.5' : ''
      )}
      onMouseEnter={() => {
        if (isTopLevel) {
    ...
    >
      <Link
        ...
        className={cn(
          ...
          compact ? 'mx-auto h-12 w-12 justify-center rounded-[1rem] border-transparent bg-transparent p-0 shadow-none' : 'min-h-[3.55rem] w-full rounded-[1.1rem] px-2.5 py-2.5',
        ...
        >
          <span
            className={cn(
              ...
              compact ? 'rounded-[calc(0.95rem-1px)]' : level === 0 ? 'rounded-[calc(1rem-1px)]' : 'rounded-[calc(0.9rem-1px)]',
              active
...
export function Sidebar({
  ...
  return (
    ...
    >
      <div className="flex h-full min-w-0 min-h-0 flex-1 flex-col px-3 py-4">
