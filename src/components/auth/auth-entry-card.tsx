...
export function AuthEntryCard({
  ...
  return (
    <main className="auth-shell min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-5 lg:grid-cols-[minmax(0,1.1fr)_440px]">
        <section className="dashboard-spotlight relative overflow-hidden p-8 sm:p-10 lg:p-12">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_260px]">
            <div>
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-[1.15rem] border border-[rgba(124,92,255,0.16)] bg-[linear-gradient(180deg,rgba(124,92,255,0.18),rgba(62,44,112,0.14))] text-base font-semibold tracking-[0.26em] text-violet-50 shadow-[0_22px_44px_-28px_rgba(76,29,149,0.52)]">
                  BX
                </div>
                <div>
                  <h1 className="text-[1.45rem] font-semibold tracking-tight text-foreground">BarberEX</h1>
                  <p className="mt-1 text-sm text-slate-300">Operacao premium para barbearias que rodam o dia no detalhe.</p>
                </div>
              </div>

              <div className="mt-8 max-w-3xl">
                <p className="text-[2.65rem] font-semibold tracking-[-0.04em] text-foreground sm:text-[3.2rem] sm:leading-[1.02]">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                <div className="hero-stat-card min-h-[170px] p-5">
                  <p className="text-[1.05rem] font-semibold leading-7 text-foreground">
                ...
                <div className="grid gap-4">
                  <div className="hero-stat-card p-5">
            ...
            <aside className="premium-rail flex flex-col justify-between p-5">
              <div>
                <p className="text-sm font-semibold text-foreground">Tudo o que importa na mesma leitura</p>
                <p className="mt-2 text-sm leading-7 text-muted-foreground">
                  Uma entrada pensada para levar voce direto ao painel, sem ruido de produto experimental ou tela generica.
                </p>
              </div>
